...
if __name__ == '__main__':
  ...
  loss, loss_nolamb = IID_loss(torch.from_numpy(x_out), 
                               torch.from_numpy(x_tf_out))
  print(loss.numpy())

  print('The same vector:')
  x_out    = torch.from_numpy(genclust(b=b, k=k, seed=100))
  x_tf_out = torch.from_numpy(genclust(b=b, k=k, seed=100))
